...
const ON_SENTENCE = 'Auto Mode is ON: approval prompts are auto-accepted in this session — every operation that requires approval runs immediately without asking you. Do not ask for confirmation before acting; proceed directly. Exception: never request an escalation to danger-full-access on your own; if an operation needs it, state the need and wait for the user to approve it. Use extra care with destructive, irreversible, or costly operations.'
